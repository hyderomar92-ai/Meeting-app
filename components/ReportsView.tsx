...
import { FileText, Download, Printer, Loader2, Calendar, User, Search, BookOpen, CheckCircle2, TrendingUp, AlertTriangle, Filter, Shield, AlertCircle, GraduationCap, Users, Mail, Send, X } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div>
                 <label className="block text-sm font-medium text-slate-700 mb-2 flex items-center">
                    Report Audience
                    <span className="ml-2 text-xs text-blue-500 bg-blue-50 px-2 py-0.5 rounded-full">AI Context</span>
                 </label>
                 <div className="relative">
                    <Users className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400" size={16} />
                    <select
                        value={reportAudience}
                        onChange={(e) => setReportAudience(e.target.value as any)}
                        className="w-full pl-9 pr-3 py-2 rounded-lg border border-slate-200 text-sm focus:ring-2 focus:ring-blue-500 outline-none bg-white cursor-pointer"
                    >
              ...
              <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
                  <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                      <h3 className="font-bold text-slate-800 flex items-center">
                          <Mail size={18} className="mr-2 text-blue-600" /> Compose Email
                      </h3>
                  ...
                  <form onSubmit={handleSendEmail} className="p-6 space-y-4 overflow-y-auto">
                      ...
                      <div>
                          ...
                          <textarea 
                              ...
                              className="w-full px-3 py-2 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 outline-none h-48 text-sm font-mono"
                          />
                      </div>
                      <div className="pt-2 flex justify-end space-x-3">
                          ...
                          <button 
                              ...
                              className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors disabled:opacity-70"
                          >
