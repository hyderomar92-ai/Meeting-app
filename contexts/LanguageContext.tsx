...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "nav.class_overview": "Class Manager",
  ...
  fr: {
    ...
    "nav.class_overview": "Gestion de Classe",
  ...
  es: {
    ...
    "nav.class_overview": "Gestión de Clase",
  ...
  de: {
    ...
    "nav.class_overview": "Klassenübersicht",
    "nav.history": "Verlauf",
